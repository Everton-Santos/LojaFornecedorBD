...
public class TesteDB {
    private static final String JDBC_URL = "jdbc:mariadb://localhost:3307/fornecedordb";
    ...
    public static void main(String[] args) {
        try {
            ...
            String sql = "INSERT INTO fornecedor (id, titulo, lancamento) ";
            sql += " VALUES (1, 'TopGun Maverick', '2022-05-22')";
